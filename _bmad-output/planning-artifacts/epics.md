...
**Given** the pjid-emitter decision was made on 2026-09-23 and filed as [33GOD-66](https://plane.delo.sh/33god/projects/15258893-0206-4e8f-aea6-340eb217988c/issues/554b5867-5f8e-483c-8b90-c72557d1ebf9) — Traefik middleware for everything behind the proxy, plus a lazily-applied pjangler recipe for external surfaces
**When** this story closes
**Then** `docs/decisions/pjid-emitter.md` exists, records the chosen mechanism and links [33GOD-66](https://plane.delo.sh/33god/projects/15258893-0206-4e8f-aea6-340eb217988c/issues/554b5867-5f8e-483c-8b90-c72557d1ebf9) as its owning ticket on another board
**And** it states that the proxy is **retroactive by construction** — one middleware change covers every `delo.sh` surface that exists and every one added later — which is why it was chosen over the three sweep-shaped options originally costed
